...
// Development Services field mappings
const DEVELOPMENT_FIELDS: Record<string, string> = {
  ...
  hosting: 'Hosting',
  security: 'Security',
  perfExpectations: 'Perf Expectations',
  designPref: 'Design Pref',
  brandingAndAssets: 'Branding And Assets',
  uxPriority: 'UX Priority',
  accessibility: 'Accessibility',
  websiteFeatures: 'Website Features',
  saasFeatures: 'SaaS Features',
  appFeatures: 'App Features',
  softwareFeatures: 'Software Features',
  budgetRange: 'Budget Range',
  budgetApproval: 'Budget Approval',
  paymentPref: 'Payment Pref',
  roiExpectations: 'ROI Expectations',
  teamInvolvement: 'Team Involvement',
  techTeamAvailable: 'Tech Team Available',
  decisionProcess: 'Decision Process',
  pmPreference: 'PM Preference',
}

// AI Automation field mappings
const AI_AUTOMATION_FIELDS: Record<string, string> = {
  ...
  processChallenges: 'Process Challenges',
  processesToAutomate: 'Processes To Automate',
  timeSpent: 'Time Spent',
  teamSizeAffected: 'Team Size Affected',
  ...
  integrationReqs: 'Integration Reqs',
  securityReqs: 'Security Reqs',
  cloudPref: 'Cloud Pref',
  techTeam: 'Tech Team',
  gptUseCase: 'GPT Use Case',
  rpaProcessType: 'RPA Process Type',
  rpaVolume: 'RPA Volume',
  autoBudget: 'Auto Budget',
  setupBudget: 'Setup Budget',
  roiExpectations: 'ROI Expectations',
  paybackPeriod: 'Payback Period',
  implApproach: 'Impl Approach',
  training: 'Training',
  support: 'Support',
  dataSens: 'Data Sens',
  compliance: 'Compliance',
...
const TORCH_CRM_FIELDS: Record<string, string> = {
  ...
  currentCrm: 'Current CRM',
  crmSatisfaction: 'CRM Satisfaction',
  crmPainPoints: 'CRM Pain Points',
  leadVolume: 'Lead Volume',
  leadSources: 'Lead Sources',
  torchPackage: 'Torch Package',
  salesTeamSize: 'Sales Team Size',
  salesCycle: 'Sales Cycle',
  dealSize: 'Deal Size',
  conversionRate: 'Conversion Rate',
  ...
  leadScoringImp: 'Lead Scoring Imp',
  followUpPref: 'Follow Up Pref',
  nurturingNeeds: 'Nurturing Needs',
  pipelineStages: 'Pipeline Stages',
  integrations: 'Integrations',
  automationPriorities: 'Automation Priorities',
  metrics: 'Metrics',
  reportingFreq: 'Reporting Freq',
  reportRecipients: 'Report Recipients',
  dashboardPref: 'Dashboard Pref',
  customFields: 'Custom Fields',
  workflowCustom: 'Workflow Custom',
  brandingReq: 'Branding Req',
  ...
  migrationAssist: 'Migration Assist',
  migrationSources: 'Migration Sources',
  trainingReq: 'Training Req',
  supportPref: 'Support Pref',
  implTimeline: 'Impl Timeline',
  successCriteria: 'Success Criteria',
  aiInterest: 'AI Interest',
  advancedAuto: 'Advanced Auto',
  apiReq: 'API Req',
  mobileApp: 'Mobile App',
  multiLang: 'Multi Lang',
  growthExp: 'Growth Exp',
  scalingPlan: 'Scaling Plan',
  featureExp: 'Feature Exp',
  geoExp: 'Geo Exp',
}
