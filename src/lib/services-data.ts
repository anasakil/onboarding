...
export const TORCH_CRM_SERVICE: Service = {
    ...
    fields: [
        ...
        { name: 'torchPackage', label: { en: 'Which Torch CRM package interests you?', it: 'Quale pacchetto Torch CRM ti interessa?' }, type: 'select', options: [{ en: '🔥 STARTER', it: '🔥 STARTER' }, { en: '⚡ PROFESSIONAL', it: '⚡ PROFESSIONAL' }, { en: '🚀 ENTERPRISE', it: '🚀 ENTERPRISE' }], required: true, step: 3, order: 1 },
